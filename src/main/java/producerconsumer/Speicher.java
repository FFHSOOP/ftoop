...
public class Speicher implements SpeicherIf {
    ...
    /**
     * zeigt an, ob der Speicher einen neuen Wert enthaelt, der vom Drucker noch nicht abgeholt wurde
    ...
    /**
     * Zeigt an, dass der letzte Wert erreicht ist und benachrichtigt die wartenden Threads.
